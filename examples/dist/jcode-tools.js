var JCode = (() => {
  ...
  // src/jcode-tools/index.js
  var jcode_tools_exports = {};
  __export(jcode_tools_exports, {
  ...
  // src/jcode-tools/get-custom-code.js
  ...
  // src/jcode-tools/codex-client.js
  ...
  var kvHost = "https://kv.juejin.fun";
  var Storage = class {
  ...
  return __toCommonJS(jcode_tools_exports);
})();
